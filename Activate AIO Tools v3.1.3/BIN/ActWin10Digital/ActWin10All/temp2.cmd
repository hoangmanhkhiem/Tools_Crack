...
@echo off
cls
title  Script Kich Hoat Ban Quyen Windows 10 Va Windows Server Toi Nam 2038 - Copyright (C) All rights reserved.
set Unattended=
set _args=
set _elev=
set "_arg1=%~1"
...
if "%osSKU%"=="" (
%ELine%
echo Gia tri SKU khong dung. Dang huy bo...
goto K38_Done
)
...
echo Se thoat trong 3 giay nua...
